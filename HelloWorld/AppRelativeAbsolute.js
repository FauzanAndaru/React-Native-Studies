    ...
    <View style={{flex:1, flexDirection:'column'}}>
        ...
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            ...
            <View style={[styles.countainer]}>
                <View style={[styles.box, { backgroundColor: "powderblue", top:0, left:0, position:position }]} />
        ...
        <View style={{ height:75, backgroundColor: 'steelblue'}}>
            <View style={[styles.countainer, {justifyContent:'space-evenly', marginTop: 10}]}>
                <Button title="Relative" onPress={() => setPosition('relative')}
                style={{backgroundColor: "powderblue" }} />
                <Button title="Absolute" onPress={() => setPosition('absolute')}
                style={{ backgroundColor: "powderblue" }} />
            </View>
        </View>
        <View style={{ height:75, backgroundColor: 'steelblue'}}>
